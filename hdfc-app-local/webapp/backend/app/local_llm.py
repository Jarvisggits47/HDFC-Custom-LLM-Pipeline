...
STRICT_GROUNDING_INSTRUCTIONS = (
    ...
    "\n"
    "=== FACTUAL QUESTIONS ===\n"
    "1. Use the retrieved context provided below the question to answer factual questions.\n"
    "2. If retrieved context is provided, rely on it to formulate your answer. If no context is provided, answer clearly, accurately, and helpfully as an HDFC Bank customer service assistant.\n"
    "3. Never invent fake account numbers or fake personal customer details.\n"
